...
namespace ProcurementDepartament.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(ProcurementDepartamentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Role")] User user)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProcurementDepartamentContext.Users'  is null.");
            }
            var user = await _context.Users.FindAsync(id);
            if (user != null)
            {
